...
{{- if .Values.global.postgresql.auth.keycloakDbUsername }}
    {{- .Values.global.postgresql.auth.keycloakDbUsername -}}
{{- else -}}
...
{{- if .Values.global.postgresql.auth.keycloakDbName }}
    {{- .Values.global.postgresql.auth.keycloakDbName -}}
{{- else if .Values.auth.keycloakDbName -}}
    {{- .Values.auth.keycloakDbName -}}
{{- end -}}
{{- end -}}
